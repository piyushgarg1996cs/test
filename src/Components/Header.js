...
const Header = () => {
  return (
    <>
      <header className='header-top-strip py-3 header-bottom-border'>
          ...
          <div className='row'>
            ...
            <div className='col-6'>
              <p className='text-end text-white mb-0'>
                Hotline: <a className='text-white' href='tel:+91 7087679108'>+91 7087679108</a>
              </p>
            </div>
          </div>
        </div>
      ...
      <header className='header-upper py-3'>
        <div className='container-xxl'>
          <div className='row align-items-center'>
            <div className='col-2'>
              <h2>
                <Link to="/" className='text-white'>ECOMM</Link>
              </h2>
            </div>
            <div className='col-5'>
...
>
  <div className="shop-category-btn">
    ...
    <span className='d-inline-block'>Shop Category</span>
  </div>
</button>
